<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Needy_deliv.aspx.vb" Inherits="CharityGift.Needy_deliv" %>
        ...
        <div style="width:650px">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Request a delivery</h2>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example6cg" class="form-control form-control-lg" placeholder="Set recieve point (location)" />
                  <label class="form-label" for="form3Example4cg"></label>
                </div>
